...
export const dicts = {
  'fr-CA': {
    ...
    'repere.setTarget': 'Définir comme destination',
    'debug.runTest': 'Test + copier le journal', 'debug.copied': 'Copié ✓',
  ...
  en: {
    ...
    'repere.setTarget': 'Set as destination',
    'debug.runTest': 'Run test + copy log', 'debug.copied': 'Copied ✓',
